...
const postInvite = async (req, res) => {
  ...
  // check invitation is already send
  ...
  console.log("in postInvite ", targetUser);
  ...
  // if invitation has been successfully created we would like to update friends invittaion if other usere is already online
